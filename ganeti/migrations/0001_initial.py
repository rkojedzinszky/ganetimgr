    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cluster', models.ForeignKey(blank=True, to='ganeti.Cluster', null=True, on_delete=models.DO_NOTHING)),
            ],
        ),
        migrations.CreateModel(
            name='Network',
            fields=[
                ...
                ('cluster', models.ForeignKey(to='ganeti.Cluster', on_delete=models.DO_NOTHING)),
